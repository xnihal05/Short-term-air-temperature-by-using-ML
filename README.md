...
- Collect and prepare 5-10 years of hourly/daily data.
...
- Deliver reproducible code, accurate temperature forecasting model, hidden pattern discovery, research report, and zero-cost proof-of-concept.
